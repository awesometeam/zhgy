...
import com.tornado.service.CompanyInfoService;
...
public class CompanyInfoModelTest extends TestCase {
	...
	public void testGetCompanyInfo()
	{
        ...
        companyInfo.setKeyword(CompanyInfoService.companyIntroductionKeyword);
        companyInfo.setVal(sb.toString());
        PMF.save(companyInfo);
        
		new CompanyInfoModel();
		CompanyInfo result = CompanyInfoModel.getCompanyInfo(CompanyInfoService.companyIntroductionKeyword);
