...
<div id="contentPanel">
	<div id="content_wrapper">
		...
		<div id="slideshow2" class="slider2">
			<div class="conbox2">
...
<%-- 				</c:forEach> --%>
					<div><a href="###" ><img width="920" height="150" src='/zhgy/images/SlideshowPictures/wrap1.jpg'></a></div>
					<div><a href="###" ><img width="920" height="150" src='/zhgy/images/SlideshowPictures/wrap2.jpg'></a></div>
					<div><a href="###" ><img width="920" height="150" src='/zhgy/images/SlideshowPictures/wrap3.jpg'></a></div>
			</div>
	
			<div class="slideshow-switcher2">
				<a href="#" class="slideshow-cur2">1</a>
				<a href="#">2</a>
				<a href="#">3</a>
			</div>
		</div>
